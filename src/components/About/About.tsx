      ...
      <div className="container px-6 mx-auto relative z-10">
        <div className="max-w-4xl mb-24">
          <FadeIn className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-[var(--brand-gold)] text-sm font-black uppercase tracking-[4px]">The Strategic Governance Imperative</span>
          </FadeIn>
          ...
          <StaggerContainer className="space-y-6">
            <StaggerItem>
              <p className="text-slate-600 text-xl leading-relaxed font-black uppercase tracking-tight">
        ...
        <FadeIn className="flex flex-col mb-32 border-l-2 border-[var(--brand-gold)] pl-8 max-w-4xl mx-auto">
          <p className="text-[var(--brand-gold)] font-bold text-lg uppercase tracking-widest mb-2">
            This is not a technical convening.
          </p>
          <p className="text-slate-600 font-medium text-lg leading-relaxed uppercase tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          <FadeIn className="bg-white p-12 lg:p-16 border border-slate-200 relative shadow-sm">
             ...
             <StaggerContainer className="space-y-4">
                {[
                  ...
                  <StaggerItem key={i} className="flex items-center text-slate-500 font-bold uppercase tracking-tight text-sm">
             ...
             <div className="mt-8 pt-6 border-t border-slate-100">
               <p className="text-slate-600 font-bold uppercase tracking-tight text-sm leading-relaxed mb-4">
                 These forces demand GRC frameworks that are cohesive, technology-aware and insight-led.
               </p>
               <p className="text-[var(--brand-gold)] font-bold uppercase tracking-tight text-sm leading-relaxed">
          ...
          <FadeIn delay={0.2}>
            <span className="text-[10px] font-black uppercase tracking-[5px] text-slate-400 mb-6 block">The Distinctive Edge</span>
            ...
            <StaggerContainer className="space-y-8">
              {[
                ...
                <StaggerItem key={i} className="flex items-center pb-4 border-b border-slate-200">
                  ...
                  <span className="text-slate-900 font-black tracking-tight uppercase text-sm">{text}</span>
                </StaggerItem>
              ))}
            </StaggerContainer>
            <p className="mt-8 pt-6 border-t border-slate-200 text-slate-500 font-bold text-sm tracking-widest uppercase italic">
        ...
        <FadeIn className="p-12 bg-white border-l-4 border-[var(--brand-gold)] shadow-sm">
          ...
          <div className="space-y-4 max-w-4xl">
            <p className="text-slate-600 leading-relaxed font-black uppercase tracking-tight text-sm">
            ...
            <p className="text-slate-600 leading-relaxed font-black uppercase tracking-tight text-sm text-[var(--brand-gold)]">
