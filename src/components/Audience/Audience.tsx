      ...
      <div className="container px-6 mx-auto relative z-10">
        <FadeIn className="flex flex-col lg:flex-row lg:items-end justify-between mb-20 gap-8">
          <div className="max-w-5xl">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <span className="text-[#d4af37] text-sm font-bold tracking-[4px]">A Curated Executive Dialogue</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-6">
                <p className="text-slate-900 text-lg font-bold leading-relaxed tracking-tight">
                  Africa GRC Summit 1.0 is a curated, invitation-only executive forum.
                </p>
                <p className="text-slate-600 text-sm font-medium leading-relaxed tracking-widest">
              ...
              <div className="space-y-4">
                <p className="text-[#d4af37] text-sm font-bold tracking-widest">
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={i} className="flex items-center text-slate-600 text-xs font-bold tracking-widest">
                      <span className="w-1.5 h-1.5 bg-[#d4af37] mr-3 rounded-full shrink-0"></span>
                      {text}
                    </li>
                  ))}
                </ul>
                <p className="text-slate-500 text-xs font-medium tracking-widest pt-2">
            ...
            <StaggerItem key={idx}>
              <div className="group h-full p-8 bg-slate-50 border border-slate-200 hover:border-[#d4af37] hover:shadow-lg hover:shadow-[#d4af37]/5 transition-all duration-500 rounded-sm">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <span className="text-[10px] font-black tracking-[3px] text-slate-400">
                    {category.subtitle}
                  </span>
                </div>
                ...
                <ul className="space-y-4">
                  {category.roles.map((role, rIdx) => (
                    <li key={rIdx} className="flex items-start text-sm text-slate-600 font-bold tracking-tight leading-snug">
        ...
        <FadeIn delay={0.2} className="mt-20 pt-16 border-t border-slate-200 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-slate-600 text-lg font-medium leading-relaxed tracking-widest mb-2">
          ...
          <div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
              {[
                ...
                <div key={i} className="flex items-start text-slate-600 text-sm font-bold tracking-widest leading-snug">
                  <span className="w-1.5 h-1.5 bg-[#d4af37] mr-3 mt-1.5 rounded-full shrink-0"></span>
                  {text}
                </div>
              ))}
            </div>
            <p className="text-[#d4af37] text-sm font-bold tracking-widest mt-10">
